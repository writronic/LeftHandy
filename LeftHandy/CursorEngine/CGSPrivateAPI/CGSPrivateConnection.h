...
CG_EXTERN CGError CGSSetLoginwindowConnection(CGSConnectionID cid);
CG_EXTERN CGError CGSSetLoginwindowConnectionWithOptions(CGSConnectionID cid, CFDictionaryRef options);
